        ...
        <section id="offer" class="col-md-9">
            <div class="card">
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-6 mx-2 d-flex flex-md-column justify-content-between">
                            <div>
                                ...
                                <p class="mt-2 text-muted">Jogos・Xbox One</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="offer-author row">
                                    ...
                                    <div class="d-flex flex-column ml-2">
                                        <small class="text-themed font-weight-bold offer-author-name" title="Author name">Douglas Pinheiro Goulart</small>
                                        <small>Em: <span class="font-weight-bold">25/10/2020</span></small>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    <div>
                        <div class="badge badge-light" title="Visualizações">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="recommended-offer">
                        <div class="row">
                            <img src="<?= DIRIMG ?>products/<?= $offer['image'] ?>" alt="<?= $offer['name'] ?>" class="img img-fluid img-thumbnail w-25 ml-2">
                            ...
                            <div class="col-md d-flex flex-column justify-content-between ml-1 text-wrap">
                                ...
                                <div class="prices">
                                    <small class="text-muted mb-0">R$<del><?= number_format($offer['old_price'], 2, ',', '.') ?></del></small>
                                    <p class="mb-0 text-themed font-weight-bold">R$<?= number_format($offer['new_price'], 2, ',', '.') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
